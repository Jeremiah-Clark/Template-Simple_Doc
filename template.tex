...
\usepackage[$if(papersize)$$papersize$paper,$endif$margin=1in,top=1.25in,bottom=1.0in]{geometry}
\usepackage{fancyhdr}
\usepackage{xcolor}
\usepackage{graphicx}
\usepackage{enumitem}
...
% Section numbering: use 0 (not -\maxdimen) to avoid breaking longtable counters.
% Do NOT use numbersections: false in YAML — this setting handles it safely.
$if(numbersections)$
